...
export default function Expertise() {
  const [texts] = useState({
    ...
    item1: `Worked on server-side development building REST APIs and web services with the MEAN stack.`,
    item2: `Developed machine learning systems using Python libraries like NumPy, Pandas, Scikit-Learn, and TensorFlow. Built models for classification, regression, and clustering tasks including computer vision, NLP, and predictive analytics.`,
    item3: `I have a passion for academic research and gained valuable research experience during my undergraduate and graduate studies. Published conference paper at ICRTDA 2023 on an NLP technique for automated resume screening. Developed a language model using BERT and cosine similarity to match skills and experience extracted from resumes with job requirements. `,
  });
