...
export default function Index() {
  const [texts] = useState({
    ...
    head: `<script type="application/ld+json">
    {
      ...
      "name": "Arvind Jei | Software Developer",
      "description": "Portfolio website of Arvind Jei",
      "alternateName": "arvindjei.me",
    ...
    <meta property="og:title" content="Arvind Jei " />
    ...
    <meta property="og:site_name" content="Arvind Jei" />`,
  });
